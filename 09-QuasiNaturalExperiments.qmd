...
-   Thad Dunning's [book](https://www.cambridge.org/core/books/natural-experiments-in-the-social-sciences/96A64CBDC2A2952DC1C68AF77DE675AF)
...
-   RDD: Michael Barber, Daniel M. Butler and Jessica Preece (2016), "Gender Inequalities in Campaign Finance", Quarterly Journal of Political Science: Vol. 11: No. 2, pp 219-248. http://dx.doi.org/10.1561/100.00015126
    -   See critiques of candidate-characteristic RDD: Marshall, J. (2024), Can Close Election Regression Discontinuity Designs Identify Effects of Winning Politician Characteristics?. American Journal of Political Science, 68: 494-510. <https://doi.org/10.1111/ajps.12741>
...
-   Interrupted Time Series/Istrumental Variables: Rossiter, Erin Leigh, and Jeffrey Harden. "The Development of an Issue Public: Evidence from The Eras Tour." (2024). The Journal of Politics
...
***What are different types/examples of natural experiments?***
...
***What makes for a good natural/quasi experimental design?***
...
\begin{equation*}
  ...
  \end{cases}
\end{equation*} where $c$ is a threshold/point of discontinuity
...
-   We find that male legislators who barely win election against a female candidate go on to raise more money overall in the next election cycle than female candidates who barely win against male candidates.
...
Note: we could use `rdrobust` to recover the estimate we already calculated by setting a specific bandwidth `h=2` to reflect the +/- 2.
