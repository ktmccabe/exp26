...
![](images/ggt2.png) *FEDAI Table 2.1*
...
<summary>Try on your own, then expand for the answer.</summary>
...
-   The sample average is a random variable, a quantity that varies from sample to sample.[^02-causaleffects-1]
...
[^02-causaleffects-1]: Note: other books may approach this slightly differently by defining a Sample ATE, taking $D_i$ (treatment status) to be the random variable, and $Y_i(1)$ as fixed within a sample.
...
<summary>Well, let's look into some rules of expectation.</summary>

$E[Y|X] = E[Y]$ if Y and X are independent.[^02-causaleffects-2]

[^02-causaleffects-2]: See [video](https://www.youtube.com/watch?v=Ki2HpTCPwhM) for help on law of iterated expectations
