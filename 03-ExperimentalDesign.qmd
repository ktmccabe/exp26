...
The three primary conceptual readings are:
...
-   Druckman, James. Experimental Thinking. Chapter 3.
-   Salganik, Matt. [Chap 4 of Bit by Bit](https://www.bitbybitbook.com/en/1st-ed/running-experiments/)

We will also use an applied reading from Tomz and Weeks (2020) to discuss programming experiments.
...
"Validity refers to the extent to which the results of a particular experiment support some more general conclusion" (Salganik, 161)
...
![](images/druck3intv.png)

What would be examples of violations of internal validity, for example?
...
Mutz says, "Manipulation of the independent variable in an experiment need not occur by means of something that also happens regularly in the real world. In fact, it matters very little how one goes about altering the independent variable so long as it works, and so long as the researcher manipulates strictly the independent variable he/she has in mind and nothing more. To put this more succinctly, treatments do not require mundane realism (2021, 221)."
...
![](images/expdimensions.png) [*Figure 4.1*](https://www.bitbybitbook.com/en/1st-ed/running-experiments/lab-field/)
...
![](images/endorsement.png){width="40%"} ![](images/threat.png){width="40%"} ![](images/operation.png){width="40%"} ![](images/stayout.png){width="40%"}
...
-   This [blog post](https://cghlewis.com/blog/survey_data/) from Crystal Lewis also mentions several important tips and quirks of Qualtrics to consider when building a survey.
